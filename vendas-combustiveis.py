...
try:
    ...
    * **4. Validação do Grupo:** O grupo aplicou a estrutura de abas, conferiu o correto isolamento dos dados regionais por combustível e validou se a soma dos totais por aba bate com o acumulado nacional.
    ...
    st.error(f"⚠️ O arquivo `{CAMINHO_ARQUIVO}` não foi encontrado na raiz do projeto ou ocorreu um erro na leitura. Certifique-se de que o arquivo esteja com o nome exato.")import streamlit as st
import pandas as pd
import plotly.express as px
